...
import MutuellefamilleBanner from '../../Components/famille/MutuellefamilleBanner';
import QuestionsSection from '../../Components/famille/QuestionsSection';
export default function Famille() {
  return (
     <div className="min-h-screen bg-gray-100">
        {/* Bannière en pleine largeur */}
        <div className="w-full">
          <MutuellefamilleBanner/>
        </div>

...
import myImage from '../../assets/TNS/images/imageTNS.png';
...
export default function MutuelleSeniorBanner() {
  ...
  return (
    <div className="bg-blue-100 p-20  flex flex-col md:flex-row items-center justify-between rounded-lg shadow-lg">
    <div className="md:w-2/3">
      <h1 className="text-3xl font-bold text-blue-900 mb-4">
      Trouvez la mutuelle pour TNS la mieux adaptée à vos besoins
      </h1>
    ...
    <div className="md:w-1/3 mt-6 md:mt-0 flex justify-center">
      <img src={myImage} alt="Nurse Character" className="w-56 md:w-80" />
    </div>

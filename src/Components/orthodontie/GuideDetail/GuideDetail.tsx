    ...
    return (
      <div className="bg-gray-50 min-h-screen py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Paramètre invalide</h1>
          <p className="text-xl text-gray-600 mb-8">Aucun identifiant de guide fourni.</p>
          <button
            onClick={() => navigate('/AllGuidesOrthodontie')}
                ...
                >
                  ...
                  <div className="p-6">
                    <h3
                      ...
                      onClick={() => navigate(`/guideOrthodontie/${relatedGuide.id}`)}
                    >
                      {relatedGuide.title}
                    </h3>

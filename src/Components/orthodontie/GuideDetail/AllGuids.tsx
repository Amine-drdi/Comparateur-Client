...
export default function AllGuides() {
  ...
  const filteredCategories: { [key: string]: typeof guides } = {};

if (activeCategory === "all") {
  Object.keys(categories).forEach((category) => {
    const categoryGuides = categories[category as keyof typeof categories].filter(guide =>
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3
                        ...
                        onClick={() => navigate(`/guideOrthodontie/${guide.id}`)}
                      >
                        {guide.title}
                      </h3>

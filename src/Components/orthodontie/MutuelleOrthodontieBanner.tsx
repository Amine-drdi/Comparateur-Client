...
export default function MutuelleOrthodontieBanner() {
  ...
  const handleChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (event.target.value) {
      ...
      setLocation(url); // ✅ correct, string
      window.location.href = url; // ✅ redirection
    }
  };
  return (
    <div className="bg-blue-100 p-20 mt-6 flex flex-col md:flex-row items-center justify-between rounded-lg shadow-lg">
    ...
    <div className="md:w-1/3 mt-6 md:mt-0 flex justify-center">
      <img src={myImage} alt="Nurse Character" className="w-52 md:w-72" />
    </div>

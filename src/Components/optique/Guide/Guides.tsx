        ...
        <div className="max-w-7xl mx-auto p-6">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-blue-600 mb-2">
              Les guides et actualités mutuelle optique
            </h2>
            <p className="text-gray-700">
              Retrouvez nos guides enrichis ainsi que les dernières actualités sur la mutuelle optique
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {currentItems.map((guide) => (
              ...
              >
                ...
                <div className="p-4">
                <h3 
                  className="text-xl font-semibold text-blue-500 mb-3 cursor-pointer hover:text-blue-800"
                  onClick={() => navigate(`/guideOptique/${guide.id}`)} // 🔹 Redirection
                >
                  {guide.title}
                </h3>

...
const faqData: Question[] = [
  ...
  },
  {
    ...
    answer: (
      <>
        Grâce à notre simulateur, obtenez un devis gratuit et sans engagement en moins de 2 minutes. 
        <br />
        <em className="text-sm text-gray-600">
Par exemple, en juillet 2024, un couple de retraités de 65 ans a réalisé 36 % d’économies en comparant les offres de notre panel.
        </em>
      </>
    ),
  },
...
export default function FAQMutuelle() {

...
import {guides} from "../../../assets/senior/Data/guides"
import { useNavigate } from "react-router-dom";

const itemsPerPage = 6;

    export default function GuidesSenior() {
      ...
      return (
        <div className="max-w-7xl mx-auto p-6">
          <div className="mb-6">
            ...
            Les guides et actualités sur la mutuelle pour les seniors
            </h2>
            <p className="text-gray-700">
            Retrouvez nos guides-conseils ainsi que les dernières actualités sur la mutuelle pour les seniors
            ...
            {currentItems.map((guide) => (
              ...
              >
                ...
                <h3 
                  ...
                  onClick={() => navigate(`/guideSenior/${guide.id}`)} // 🔹 Redirection
                >
                  {guide.title}
                </h3>

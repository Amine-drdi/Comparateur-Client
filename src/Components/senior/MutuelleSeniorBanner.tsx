...
import senior from "../../assets/senior/images/senior.png"
...
export default function MutuelleSeniorBanner() {
  ...
  return (
    ...
    <div className="md:w-2/3">
      ...
      Trouvez la mutuelle pour senior la mieux adaptée à vos besoins
      </h1>
    ...
    <div className="md:w-1/3 mt-6 md:mt-0 flex justify-center">
      <img src={senior} alt="Nurse Character" className="w-52 md:w-72" />
    </div>

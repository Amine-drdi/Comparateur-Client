...
export default function DataComparateur() {
  ...
  const tabs: { key: CategoryKey; label: string }[] = [
    { key: 'Devis', label: 'La Mutuelle De France santé' },
    { key: 'Messages', label: 'Messages réçus' },
    ...
    if (devisData[category].length === 0) {
      return (
        <p className="text-gray-500 italic text-center">
          Aucun devis disponible pour cette catégorie. {user.email}
          {user.codePostal}
        </p>
      );
    }

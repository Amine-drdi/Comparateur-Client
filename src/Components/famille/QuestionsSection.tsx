...
import famille from "../../assets/famille/images/sofia-shultz-59970339-8015551-removebg-preview.png"
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex text-sm mb-8 text-gray-600">
        ...
        <span className="mx-2">›</span>
        <span className="text-gray-500">Profil - Protection familiale : quelle est la meilleure mutuelle pour famille en 2025 ?</span>
      </div>

      <h1 className="text-3xl font-bold text-blue-600 mb-6">
      Mutuelle senior : quelle est la meilleure mutuelle pour familleZ en 2025 ?
      </h1>

      <section className="mt-10 max-w-4xl mx-auto px-4">
      <p className="text-gray-700 mb-6 leading-relaxed">
       Une mutuelle familiale offre de nombreux avantages pour tous les membres du foyer. Elle prend en charge une partie importante des dépenses de santé en venant compléter les remboursements de l’Assurance Maladie, notamment pour le ticket modérateur et les dépassements d’honoraires. En regroupant l’ensemble de la famille sous un seul contrat, elle permet également de bénéficier de garanties renforcées à un tarif plus intéressant.

Comme toute complémentaire santé, elle reste facultative, mais s’avère vivement recommandée : elle contribue à alléger vos frais médicaux et à mieux maîtriser votre budget santé.  
      </p>
      ...
      <div className="bg-blue-50 p-6 rounded-lg mb-8">
        ...
        <ol className="list-decimal pl-6 space-y-2">
          <li>
           ...
           Pourquoi souscrire une mutuelle famille en 2025 ?

            </a>
          </li>
          <li>
            <a href="#section2" className="text-blue-500 hover:underline">
            Quelle mutuelle famille choisir selon votre profil ?
            </a>
          </li>
          {isExpanded && (
            <>
              <li>
                ...
                Mutuelle famille pas chère : notre sélection
                </a>
              </li>
              <li>

...
type Category = "Mutuelle santé" | "Contrats et droits" | "Remboursements spécifiques";
...
export default function AllGuides() {
  ...
  const categories: Record<Category, typeof guides> = {
  ...
  const handleCategoryChange = (category: SetStateAction<"all" | Category>) => {
  ...
  const filteredCategories: Partial<Record<Category, Guide[]>> = {};
  ...
  if (activeCategory === "all") {
    ...
    filteredCategories[activeCategory as Category] = filteredGuides;
  }
    ...
    <div className="bg-gray-50 py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Tous nos guides de santé</h1>
            ...
            <p className="text-gray-500">
              {searchTerm.trim() !== ""
                ? `Aucun guide ne correspond à votre recherche "${searchTerm}" ${
                    activeCategory !== "all" ? `dans la catégorie "${activeCategory}"` : ""
                  }.`
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3
                        ...
                        onClick={() => navigate(`/guideExpatries/${guide.id}`)}
                      >
                        {guide.title}
                      </h3>
